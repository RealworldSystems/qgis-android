...
/**
 * A reader exception is thrown whenever a failure occurs in a Reader object
 *
...
public class ReaderException extends Exception
{
    ...
    /*package*/ ReaderException(String message, Throwable cause)
    {
	super(message, cause);
    }
    
    /*package*/ ReaderException(String message)
    {
	super(message);
    }
}